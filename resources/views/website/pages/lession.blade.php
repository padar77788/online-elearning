...
<div class="row mt-5">
  ...
  @endforeach
    ...
    <div class="col-md-8">
      <!-- 16:9 aspect ratio -->
        <h3 class="text-black border-bottom ">{{ $singleLession->title }}</h3>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-10">
                              <textarea name="comment" class="form-control" rows="2" cols="80"></textarea>
                               <input type="submit" class="btn btn-success p-1 rounded mt-1" name="btn" value="Comment">
                            </div>
                          </div>
                            ...
                            <div class="col-md-10">
                                <form class="" action="{{ route('reply')}}" method="post">
                                  ...
                                  <div class="col-md-10">
                                    ...
                                    <input type="hidden" name="lesson_id" value="{{ $singleLession->id }}">
                                      <textarea name="text" rows="2" class="form-control" cols="60"></textarea>
